...
-- 
CREATE TYPE order_status_type  AS ENUM('awaiting restaurant confirmation', 'searching for delivery partner', 'awaiting pickup', 'awaiting delivary', 'delivered', 'cancelled');
